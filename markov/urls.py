...
urlpatterns = [
    ...
    path("partitions/compare/", views.partition_comparison, name="partition_comparison"),
    path("partitioner-3d/", views.partitioner_3d, name="partitioner_3d"),
    path("partitioner-3d/trame/", views.partitioner_3d_trame, name="partitioner_3d_trame"),
    ...
    path("api/tab/dem-markov/", views.api_dem_vs_markov_tab, name="api_dem_vs_markov_tab"),
    
    # 3D Partitioner APIs
    path("api/partitioner/schemas/", views.api_partitioner_schemas, name="api_partitioner_schemas"),

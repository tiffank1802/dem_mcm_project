...
def card_glass(request):
    """Page des cartes avec effet liquid glass."""
    ...
    dynamic_cards = [
        ...
        },
        {
            ...
            'title': 'Avis',
            'value': '4.8/5',
            'description': '1,204 avis clients',
            'links': [],
        },
    ]
    ...
    context = {
        ...
        'page_title': 'Liquid Glass Cards',
    }
    return render(request, 'glass_app/card_glass.html', context)
